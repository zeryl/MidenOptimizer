      ...
      switch(HEROES[i]){
        case 1:
          ...
          switch(Math.min(T1M,T1G,T1W,T1F)){
            case T1M:
              $(".t1m").css("color", "#66ff33");
              break;
            case T1G:
              $(".t1g").css("color", "#66ff33");
              break;
            case T1W:
              $(".t1w").css("color", "#66ff33");
              break;
            case T1F:
              $(".t1f").css("color", "#66ff33");
              break;
          }
          break;
        case 2:
          ...
          switch(Math.min(T2M,T2G,T2W,T2F)){
            case T2M:
              $(".t2m").css("color", "#66ff33");
              break;
            case T2G:
              $(".t2g").css("color", "#66ff33");
              break;
            case T2W:
              $(".t2w").css("color", "#66ff33");
              break;
            case T2F:
              $(".t2f").css("color", "#66ff33");
              break;
          }
          break;
        case 3:
          ...
          switch(Math.min(T3M,T3G,T3W,T3F)){
            case T3M:
              $(".t3m").css("color", "#66ff33");
              break;
            case T3G:
              $(".t3g").css("color", "#66ff33");
              break;
            case T3W:
              $(".t3w").css("color", "#66ff33");
              break;
            case T3F:
              $(".t3f").css("color", "#66ff33");
              break;
          }
          break;
        case 4:
          ...
          switch(Math.min(T4M,T4G,T4W,T4F)){
            case T4M:
              $(".t4m").css("color", "#66ff33");
              break;
            case T4G:
              $(".t4g").css("color", "#66ff33");
              break;
            case T3W:
              $(".t4w").css("color", "#66ff33");
              break;
            case T4F:
              $(".t4f").css("color", "#66ff33");
              break;
          }
          break;
        case 5:
          ...
          switch(Math.min(T5M,T5G,T5W,T5F)){
            case T5M:
              $(".t5m").css("color", "#66ff33");
              break;
            case T5G:
              $(".t5g").css("color", "#66ff33");
              break;
            case T5W:
              $(".t5w").css("color", "#66ff33");
              break;
            case T5F:
              $(".t5f").css("color", "#66ff33");
              break;
          }
          break;
      }
